...
impl GenerationLimits {
    pub const INTERACTIVE_WEIGHTED: Self = Self {
        max_depth: 80,
...
impl GenerationRequest<'_> {
    ...
    pub const fn with_seed(seed: u64) -> Self {
        Self {
            entry: None,
            seed,
            limits: GenerationLimits::INTERACTIVE_WEIGHTED,
            data: &[],
...
impl CompiledGrammar {
    ...
    pub fn audit_composition(&self) -> Vec<CompositionFinding> {
        let profile = crate::CompositionProfile::DEFAULT;
...
fn package_artifact_hash(package: &PackageInput, manifest: &MessageManifest) -> u64 {
    ...
    hash.string("mecojoni-artifact-fnv-a64/1");
...
const PRODUCTION_ID_HASH_VERSION: &str = "production-fnv-a64/1";
...
fn diverse_eligible_weights(
    ...
    let profile = crate::LocationProfile::DEFAULT;
...
mod tests {
    ...
    impl Formatter for EnglishFormatter {
        fn format(&mut self, request: &FormatterRequest) -> MecoResult<FormatterResult> {
            ...
            Ok(FormatterResult {
                ...
                environment_hash: "test-formatter/en-current".to_string(),
                diagnostics: vec![],
                work_units: 1,
                replayable: true,
            })
    ...
    fn formatter_results_enforce_locale_work_provenance_diagnostics_and_output_limits() {
        ...
        let valid = FormatterResult {
            ...
            actual_locale: "en".to_string(),
            environment_hash: "formatter/current".to_string(),
            diagnostics: vec![],
            work_units: 1,
            replayable: true,
        };
